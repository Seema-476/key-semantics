                        ...
                        <div className='pb-4'>
                            {KEY_INDRODUTION.map((introdution, index) => (
                                <div key={index} className='relative after:w-1 after:h-1 after:rounded-full after:bg-dark-blue after:top-2 md:after:top-[14px] after:left-2 after:absolute after:content-[""]'>
                                    <p className='font-normal md:text-base text-sm md:leading-7 text-deep-blue pl-6 pb-2 lg:max-w-[512px]'>{introdution}</p>
                                </div>
                            ))}
                        </div>
                                                ...
                                                <div className='pb-4'>
                                                    <div>
                                                        ...
                                                        <div className='flex justify-between flex-wrap gap-2'>
                                                            <img src="/assets/images/webp/colorfull-image.webp" alt="color" className='xl:max-w-[268px] w-full pointer-events-none' />
