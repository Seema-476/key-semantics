...
export const FREQUENTLY_ASK_QUESTIONS = [
    {
        ...
        secondAnswer: "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.",
        thirdAnswer: "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    },
    {
...
export const WORK_LIST = [
    ...
    },
    {
        lottietext: Search,
        alt: 'Animation 2',
        description: "Using highly optimized and trained AI models, we analyze, vectorize and extract semantic information relations from your content.",
    },
    {
        lottietext: ServerSearch,
        alt: 'Animation 3',
